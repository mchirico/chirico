...
http://chirico.googlecode.com/svn/trunk/bash/pingtest/devwstat.py
...
I was thinking about using pickle, but that 
takes just as long to load.
...
#	pf=open('fileMarker')
	...
	return [m,h,top,delta,delta2,TELL]



def main(N):

	[m,h,top,delta,delta2,TELL] = openAndRead()
