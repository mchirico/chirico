/* match.c */
/*  Reference: http://www.danlj.org/lad/src/ladsrc.tar.gz */

/*
gcc  -Wall -W -Wconversion -Wshadow -Wcast-qual -Wwrite-strings aregex.c  -o aregex   -lfl
...
int main(void)
{
  aregx("(aab(c[0-9]*z)[ ]*.*$)|(^[^#]+$)","aabc34z one two");
  return 0;
}
