...
public class TableWithTimerCmdDev extends JFrame implements ActionListener, Runnable {

    // Clean this up later .. maybe make private
    ...
    public TableWithTimerCmdDev() {
        ...
        addGB(new JScrollPane(myTable), x = 0, y = 0);
        constraints.gridheight = 1;	// set it back
        addGB(startButton,	x = 1, y = 0);
        addGB(stopButton,	x = 2, y = 0);
        constraints.gridwidth = 2; // span two columns
        addGB(new JButton("one"),	x = 1, y = 1);
    ...
    public void run() {
        ...
        int row = 0;
        while (count < myTable.getRowCount()) {
